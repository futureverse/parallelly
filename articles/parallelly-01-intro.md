...
The
[`availableCores()`](https://parallelly.futureverse.org/reference/availableCores.md)
function is designed as a better, safer alternative to
[`detectCores()`](https://rdrr.io/r/parallel/detectCores.html) of the
**parallel** package. It is designed to be a worry-free solution for
developers and end-users to query the number of available cores - a
