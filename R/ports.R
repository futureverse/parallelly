...
#' `"random"`. If \env{R_PARALLEL_PORT} is not set, the default
#' is `"random"`. The `"auto"` alternative is used for full
#' backward compatibility with the **parallelly** package.
#'
...
#'
#' @return
#' Returns an integer representing the first port among `ports` _that
